var https = require("https"),
    loggly = require('coremdServer-modules/utils/loggly/loggly');
...
UrbanAirship.prototype._transport = function(path, method, request_data, callback) {
	...
	var request = https.request(https_opts, function(response) {
		...
		response.on("end", function() {
			var msg = {
				'message' : 'Pushwoosh notification sent from the server',
				'data' : response_data
			};
			loggly.log(msg, "UrbanAirship-pushwoosh-response");
